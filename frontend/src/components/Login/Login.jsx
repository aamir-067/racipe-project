                    ...
                    <div className="absolute w-96 z-10 py-10 pl-4 text-center bg-white bg-opacity-45 rounded-lg flex flex-col">
                        <div className="w-full z-30 flex flex-col ml-4">
                            ...
                            <form className="text-center flex flex-col">
                                ...
                                <input type="email" className='my-2 p-3 rounded outline-none h-10 text-black w-80' placeholder='username or email' />
                                ...
                                <label className="mr-12 text-center">didn't have account?
                                    <NavLink to={"/register"}>
                                        <label className='cursor-pointer text-blue-700 ml-2 border-blue-700'>click here</label>
                                    </NavLink>
                                </label>
                            </form>
                        </div>
