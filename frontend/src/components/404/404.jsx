...
export default function Error() {
    ...
    return (
        <div className="flex items-center mt-28 justify-center px-2 md:px-0">
            <div>
                ...
                <div className="mt-6 flex items-center space-x-3">
                    ...
                    <a target='_blank' href="mailto:aamirkhan@engineer.com?subject=Error in Aamferr: Can't access a specific page&body=describe an error here">
